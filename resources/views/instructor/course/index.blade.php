...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ url('instructor/delete-course') }}" method="POST">
                @csrf
                @method('DELETE')
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{url('instructor/add-course')}}" class="btn btn-primary btn-sm text-white float-end">Add New</a>
            </div>
                    ...
                    <tbody>
                        @forelse ($active_courses as $course)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning btn-sm text-white" href="{{url('instructor/view-course/'.$course->id)}}">View</a>
                                    <a href="{{url('instructor/edit-course/'.$course->id)}}" class="btn btn-success btn-sm text-white">Edit</a>
                                    <button type="button" value="{{$course->id}}" class="btn btn-danger btn-sm text-white deleteCourseBtn">Delete</a>
                                </td>
                            </tr>
                            @empty
                                <tr><td colspan="4"><p>No Active Course</p></td></tr>
                        @endforelse
                    </tbody>
                </table>      
            </div>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        @forelse ($pending_courses as $course)
                            ...
                            @empty
                            <tr><td colspan="4"><p>No Pending Course</p></td></tr>
                        @endforelse
                    </tbody>
                </table>
